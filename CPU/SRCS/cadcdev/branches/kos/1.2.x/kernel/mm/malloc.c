...
CVSID("$Id: malloc.c,v 1.8 2002/10/26 07:59:30 bardtx Exp $");
  ...
  if (brk != (char*)(MORECORE_FAILURE)) {
    ...
    */
      ...
      /* handle non-contiguous cases */
        ...
        assert(((ptr_t)chunk2mem(brk) & MALLOC_ALIGN_MASK) == 0);
...
#endif
{
  ...
  */
  ...
  if ((((ptr_t)(m)) % alignment) != 0) { /* misaligned */
    ...
    */
    ...
    brk = (char*)mem2chunk(((ptr_t)(m + alignment - 1)) &
                           -((signed long) alignment));
    if ((ptr_t)(brk - (char*)(p)) < MINSIZE)
      brk += alignment;
