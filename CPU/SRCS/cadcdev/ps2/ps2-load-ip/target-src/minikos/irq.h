/* ps2-load-ip
   ...
   $Id: irq.h,v 1.1 2002/10/30 05:34:13 bardtx Exp $
*/

// Adapted from KOS' arch/ps2/include/irq.h

/* There's more stuff in here than we currently use, but eventually I'd like
   to have an exception handler in place. */
