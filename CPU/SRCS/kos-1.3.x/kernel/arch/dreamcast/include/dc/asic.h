/* KallistiOS ##version##
   ...
   $Id: asic.h,v 1.5 2003/07/31 00:42:41 bardtx Exp $
...
/* Non-public version */
struct kprocess;
int _asic_evt_set_handler(struct kprocess * proc, uint32 code, asic_evt_handler handler);
...
/* Remove all handlers attached to the named process. */
void asic_remove_process(struct kprocess * proc);
