...
CVSID("$Id: sem.c,v 1.16 2003/07/31 00:40:30 bardtx Exp $");
...
void sem_freeall(struct kprocess * proc) {
	...
	sm = LIST_FIRST(&sem_list);
	while (sm) {
		nsm = LIST_NEXT(sm, g_list);
