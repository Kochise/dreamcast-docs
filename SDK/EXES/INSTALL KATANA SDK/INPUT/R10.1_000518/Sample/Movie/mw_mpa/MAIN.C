...
/********************************************************************************************/
/* Name:     Mw_mpa.c                                                                       */
/* Title:    Middleware MPEG Audio Player Example                                           */
/* Author:   Joe Votour                                                                     */
...
/*                                                                                          */
/* Description:                                                                             */
/* This program will play an MPEG audio file using the Middleware libraries.  This program  */
/* is an update of the mw_mpa01 program, updated to use Kamui2 and Audio64 (AC or AM layer).*/
/*                                                                                          */
/* History:                                                                                 */
...
/********************************************************************************************/
/* Initialize Middleware MPEG audio playing software					    */
/********************************************************************************************/
void ApInitMw(AP ap)
{
...
/********************************************************************************************/
/* Start the Middleware MPEG audio playing						    */
/********************************************************************************************/
void ApStart(AP ap)
{
...
void ApStop(AP ap)
{
	...
	mwPlyDestroy(ap->ply);
	ap->ply = NULL;
	syFree(ap->cprm.libwork);
	ap->cprm.libwork = NULL;
	syFree(ap->cprm.buf);
	ap->cprm.buf = NULL;
}
