# Microsoft Developer Studio Project File - Name="bumpmapping" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "bumpmapping.mak".
!MESSAGE 
...
# ADD LINK32 coredll.lib corelibc.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /pdb:"..\..\..\release\retail\Samples/bumpmapping.pdb" /machine:SH4 /nodefaultlib /out:"..\..\..\release\retail\Samples/bumpmapping.exe" /libpath:"..\..\lib\retail" /libpath:"..\..\..\lib\retail" /subsystem:$(CESubsystem)
...
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 coredll.lib corelibc.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /incremental:no /pdb:"..\..\..\release\debug\Samples/bumpmapping.pdb" /debug /machine:SH4 /nodefaultlib /out:"..\..\..\release\debug\Samples/bumpmapping.exe" /libpath:"..\..\lib\debug" /libpath:"..\..\..\lib\debug" /subsystem:$(CESubsystem)
# SUBTRACT LINK32 /pdb:none
...
# Name "bumpmapping - Win32 (WCE SH4) Release"
# Name "bumpmapping - Win32 (WCE SH4) Debug"

# Begin Source File
SOURCE=.\bumpmapping.cpp
# End Source File
# Begin Source File
