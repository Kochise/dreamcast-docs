...
Abstract:
   ...
   This file contains Direct3D functionality for the bumpmapping sample.
...
LPDIRECT3DMATERIAL3 g_pmatBlack;              // Global black material
...
static D3DVECTOR g_vectFrom(0.0f, 0.0f, 8.0f);
               ...
               float rEmisR, float rEmisG, float rEmisB)
{
    ...
    mat.power      = rPower;
    mat.hTexture   = NULL;
    // Don't need to set mat.dwRampSize since Dragon is RGB-only.
