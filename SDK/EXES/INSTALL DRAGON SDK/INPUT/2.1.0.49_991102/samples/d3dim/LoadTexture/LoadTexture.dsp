# Microsoft Developer Studio Project File - Name="LoadTexture" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "LoadTexture.mak".
!MESSAGE 
...
# ADD LINK32 coredll.lib corelibc.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /pdb:"..\..\..\release\retail\Samples/LoadTexture.pdb" /machine:SH4 /nodefaultlib /out:"..\..\..\release\retail\Samples/LoadTexture.exe" /libpath:"..\..\lib\retail" /libpath:"..\..\..\lib\retail" /subsystem:$(CESubsystem)
...
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 coredll.lib corelibc.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /incremental:no /pdb:"..\..\..\release\debug\Samples/LoadTexture.pdb" /debug /machine:SH4 /nodefaultlib /out:"..\..\..\release\debug\Samples/LoadTexture.exe" /libpath:"..\..\lib\debug" /libpath:"..\..\..\lib\debug" /subsystem:$(CESubsystem)
# SUBTRACT LINK32 /pdb:none
...
# Name "LoadTexture - Win32 (WCE SH4) Release"
# Name "LoadTexture - Win32 (WCE SH4) Debug"
