...
Abstract:
   ...
   This file contains DirectDraw functionality for the RearViewMirror sample.
...
// ++++ Global Variables ++++++++++++++++++++++++++++++++++++++++++++
LPDIRECTDRAW4        g_pdd = NULL;         // The DirectDraw object
LPDIRECTDRAWSURFACE4 g_pddsPrimary = NULL;// Primary DirectDraw surface
...
CreateDirectDrawDevice()
{
    ...
    g_errLast = DirectDrawCreate(NULL, &pdd, NULL);
    if (CheckError(TEXT("Creation of DirectDraw Object")))
        return FALSE;

    g_errLast = pdd->QueryInterface(IID_IDirectDraw4, (LPVOID*)&g_pdd);
    pdd->Release();
    if (CheckError(TEXT("Query of DirectDraw Object for IDirectDraw4 interface")))
        return FALSE;
...
Return Value:
    ...
    LPDIRECTDRAWSURFACE4 -   A pointer to the loaded texture
