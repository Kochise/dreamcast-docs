DirectMusic sample program -- PlayPrimary
-----------------------------------------

* Purpose:
This sample application shows how to play a primary DMusic segment.

* Required Files\Parameters:
Usage for playprimary:
        playprimary [-p searchpath] [-r #repeats] [-?] [segment]

        If the "-p" parameter is not set, PlayPrimary sets the search directory 
        ...
        If the "segment" parameter is not provided, PlayPrimary will play the 
