...
Abstract:
   ...
   This file contains DirectInput functionality for the Keyboard sample.
...
CKeyboard     *g_rgpcont[MAX_CONTROLLERS];    // The list of active input devices
...
PollDevices()
{
    ...
    {
        CKeyboard *pcont = g_rgpcont[iPort];
        if (pcont != NULL)
        {
...
DIEnumProc(LPCDIDEVICEINSTANCE pdidi, LPVOID pvContext)
{
    ...
    case DIDEVTYPE_KEYBOARD:
        if (IsNewDevice(pdidi->guidInstance))
        {
            ...
            pcontNew = new CKeyboard(pdidi->guidInstance);
    ...
    case DIDEVTYPE_JOYSTICK:
        // Joysticks are not supported in this sample.
        break;
