    ...
    )
{
    ...
    if (!CreateDirectInput (g_hinstApp, g_hwndApp, &g_pdidevice2JoystickSKB))
    {
    ...
    )
{
    ...
    static WORD iKeyTop = 0;
    HIMC hIMC;
    static DWORD dwSentMode;
    static DWORD dwConvMode;
    ...
    if (g_bSWNDactive)
    {
        SWNDReadDirectInputDevices(&iKeyTop);
    }
