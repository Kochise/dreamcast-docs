    ...
    )
{
    ...
    g_pskCurrentSWND[g_cSpecialKeys].szKeyString[0] = KANJI_REJECT_0;
    g_pskCurrentSWND[g_cSpecialKeys].szKeyString[1] = KANJI_REJECT_1;
    g_pskCurrentSWND[g_cSpecialKeys].szKeyString[2] = '\0';
