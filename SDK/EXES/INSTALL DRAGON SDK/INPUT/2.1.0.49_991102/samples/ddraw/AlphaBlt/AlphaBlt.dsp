# Microsoft Developer Studio Project File - Name="AlphaBlt" - Package Owner=<4>
...
# ADD LINK32 coredll.lib corelibc.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /pdb:"..\..\..\release\retail\Samples/AlphaBlt.pdb" /machine:SH4 /nodefaultlib /out:"..\..\..\release\retail\Samples/AlphaBlt.exe" /libpath:"..\..\lib\retail" /libpath:"..\..\..\lib\retail" /subsystem:$(CESubsystem)
...
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 coredll.lib corelibc.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /incremental:no /pdb:"..\..\..\release\debug\Samples/AlphaBlt.pdb" /debug /machine:SH4 /nodefaultlib /out:"..\..\..\release\debug\Samples/AlphaBlt.exe" /libpath:"..\..\lib\debug" /libpath:"..\..\..\lib\debug" /subsystem:$(CESubsystem)
# SUBTRACT LINK32 /pdb:none
...
# Name "AlphaBlt - Win32 (WCE SH4) Release"
# Name "AlphaBlt - Win32 (WCE SH4) Debug"

# Begin Source File
SOURCE=.\AlphaBlt.cpp
# End Source File
# Begin Source File
SOURCE=.\CAlphaSurface.cpp
# End Source File
# Begin Source File
SOURCE=.\AlphaBlt.rc
# End Source File
