# Microsoft Developer Studio Project File - Name="D3DSiberian" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "D3DSiberian.mak".
!MESSAGE 
...
TargetPath=.\WCESH4Rel\D3DSiberian.exe
SOURCE="$(InputPath)"
...
# Begin Special Build Tool
TargetPath=.\WCESH4Dbg\D3DSiberian.exe
SOURCE="$(InputPath)"
PostBuild_Desc=Copying...
PostBuild_Cmds=dccopy $(TargetPath)
# End Special Build Tool
...
# Name "D3DSiberian - Win32 (WCE SH4) Release"
# Name "D3DSiberian - Win32 (WCE SH4) Debug"
# Begin Group "Source"

# PROP Default_Filter ""
# Begin Source File

SOURCE=.\D3DSiberian.c
DEP_CPP_D3DSI=\
	".\D3DShell.h"\
	".\D3DSiberian.h"\
	".\D3DTools.h"\
