# Microsoft Developer Studio Project File - Name="PlayVideo" - Package Owner=<4>
...
# ADD LINK32 coredll.lib corelibc.lib ole32.lib strmiids.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /pdb:"..\..\..\release\retail\Samples/PlayVideo.pdb" /machine:SH4 /nodefaultlib /out:"..\..\..\release\retail\Samples/PlayVideo.exe" /libpath:"..\..\lib\retail" /libpath:"..\..\..\lib\retail" /subsystem:$(CESubsystem)
...
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 coredll.lib corelibc.lib ole32.lib strmiids.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /incremental:no /pdb:"..\..\..\release\debug\Samples/PlayVideo.pdb" /debug /machine:SH4 /nodefaultlib /out:"..\..\..\release\debug\Samples/PlayVideo.exe" /libpath:"..\..\lib\debug" /libpath:"..\..\..\lib\debug" /subsystem:$(CESubsystem)
# SUBTRACT LINK32 /pdb:none
...
# Name "PlayVideo - Win32 (WCE SH4) Release"
# Name "PlayVideo - Win32 (WCE SH4) Debug"
