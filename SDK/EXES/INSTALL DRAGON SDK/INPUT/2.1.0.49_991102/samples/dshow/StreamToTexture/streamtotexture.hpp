...
Abstract:
   ...
   Include file for StreamToTexture
...
// DShowUtil.cpp functions
IMultiMediaStream  *OpenMMStream(TCHAR *tszFileName);
IDirectDrawSurface *CreateMMSRenderTarget(IMultiMediaStream *pmmstream, IDirectDrawStreamSample **ppddssStream, HANDLE *phEndOfStream);
LPDIRECT3DTEXTURE2 Create3DMMSRenderTarget(IMultiMediaStream *pmmstream, IDirectDrawStreamSample **ppddssStream, HANDLE *phEndOfStream);
