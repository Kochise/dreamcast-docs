# Microsoft Developer Studio Project File - Name="DirectSound3D" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "DirectSound3D.mak".
!MESSAGE 
...
# ADD LINK32 coredll.lib corelibc.lib dsound.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /pdb:"..\..\..\release\retail\Samples/DirectSound3D.pdb" /machine:SH4 /nodefaultlib /out:"..\..\..\release\retail\Samples/DirectSound3D.exe" /libpath:"..\..\lib\retail" /libpath:"..\..\..\lib\retail" /subsystem:$(CESubsystem)
...
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 coredll.lib corelibc.lib dsound.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /incremental:no /pdb:"..\..\..\release\debug\Samples/DirectSound3D.pdb" /debug /machine:SH4 /nodefaultlib /out:"..\..\..\release\debug\Samples/DirectSound3D.exe" /libpath:"..\..\lib\debug" /libpath:"..\..\..\lib\debug" /subsystem:$(CESubsystem)
# SUBTRACT LINK32 /pdb:none
...
# Name "DirectSound3D - Win32 (WCE SH4) Release"
# Name "DirectSound3D - Win32 (WCE SH4) Debug"

# Begin Source File
SOURCE=.\DirectSound3D.cpp
# End Source File
# Begin Source File
SOURCE=.\DSUtil.cpp
# End Source File
