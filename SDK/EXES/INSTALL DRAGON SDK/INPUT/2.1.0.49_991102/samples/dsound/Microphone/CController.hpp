...
public:
    ...
    // Called when an Microphone is discovered to be attached to the device
    void MicrophoneExists(GUID guidMicrophone);

    CMicrophone *GetMicrophone() { return m_pMicrophone; };
