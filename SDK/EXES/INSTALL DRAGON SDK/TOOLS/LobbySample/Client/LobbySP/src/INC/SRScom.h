...
//   プロセス名
//=========================================
#define	SRS_PROC_INITIAL	TEXT("SRSinitial")		// サーバ要求待ちプロセス
#define	SRS_PROC_LOG		TEXT("SRSlog.exe")		// ログ表示プロセス
#define	SRS_PROC_LOBBY		TEXT("SRSlobby")		// サーバLobbyプロセス
#define SRL_PROC_RCV		TEXT("SRLreceive.exe")	// クライアント受信プロセス
#define SRL_PROC_SEND		TEXT("SRLsend.exe")	    // クライアント送信プロセス
...
struct	SRS_IF_CONNECT
{
	...
	char	IF_CN_cMessage[SRS_MAX_MESSAGE];		// 表示メッセージ
};
