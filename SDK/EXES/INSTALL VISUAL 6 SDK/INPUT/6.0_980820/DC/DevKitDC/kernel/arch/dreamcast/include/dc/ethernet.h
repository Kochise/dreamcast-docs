 ...
 * (c)2001 Dan Potter
 *
 * $Id: ethernet.h,v 1.2 2002/01/05 07:33:51 bardtx Exp $
 */

#ifndef __DC_ETHERNET_H
#define __DC_ETHERNET_H
...
#define ETH_TX_OK	0
#define ETH_TX_ERROR	-1
#define ETH_TX_AGAIN	-2
#define ETH_TX_NOWAIT	0
#define ETH_TX_WAIT	1
