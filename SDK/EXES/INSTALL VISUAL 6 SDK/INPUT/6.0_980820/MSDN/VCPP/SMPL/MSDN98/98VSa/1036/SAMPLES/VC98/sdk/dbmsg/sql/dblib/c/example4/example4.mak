...
!IF "$(CFG)" == ""
CFG=Example4 - Win32 (PPC) Debug
!MESSAGE No configuration specified.  Defaulting to Example4 - Win32 (PPC)\
 Debug.
!ENDIF 

!IF "$(CFG)" != "Example4 - Win32 Release" && "$(CFG)" !=\
 "Example4 - Win32 Debug" && "$(CFG)" != "Example4 - Win32 (ALPHA) Debug" &&\
 "$(CFG)" != "Example4 - Win32 (ALPHA) Release" && "$(CFG)" !=\
 "Example4 - Win32 MIPS Debug" && "$(CFG)" != "Example4 - Win32 MIPS Release" &&\
 "$(CFG)" != "Example4 - Win32 (PPC) Release" && "$(CFG)" !=\
 "Example4 - Win32 (PPC) Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "Example4.mak" CFG="Example4 - Win32 (PPC) Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "Example4 - Win32 Release" (based on\
 "Win32 (x86) Console Application")
!MESSAGE "Example4 - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE "Example4 - Win32 (ALPHA) Debug" (based on\
 "Win32 (ALPHA) Console Application")
!MESSAGE "Example4 - Win32 (ALPHA) Release" (based on\
 "Win32 (ALPHA) Console Application")
!MESSAGE "Example4 - Win32 MIPS Debug" (based on\
 "Win32 (MIPS) Console Application")
!MESSAGE "Example4 - Win32 MIPS Release" (based on\
 "Win32 (MIPS) Console Application")
!MESSAGE "Example4 - Win32 (PPC) Release" (based on\
 "Win32 (PPC) Console Application")
!MESSAGE "Example4 - Win32 (PPC) Debug" (based on\
 "Win32 (PPC) Console Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "Example4 - Win32 Release"
...
ALL : "$(OUTDIR)\Example4.exe"

CLEAN : 
	-@erase ".\Release\Example4.exe"
	-@erase ".\Release\Example4.obj"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D\
 "DBNTWIN32" /Fp"$(INTDIR)/Example4.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/Example4.bsc" 
BSC32_SBRS=
LINK32=link.exe
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/Example4.pdb" /machine:I386 /out:"$(OUTDIR)/Example4.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Example4.obj"

"$(OUTDIR)\Example4.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase ".\Debug\Example4.exe"
	-@erase ".\Debug\Example4.obj"
	-@erase ".\Debug\Example4.ilk"
	-@erase ".\Debug\Example4.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE"\
 /D "DBNTWIN32" /Fp"$(INTDIR)/Example4.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/"\
 /c 
CPP_OBJS=.\Debug/
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/Example4.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/Example4.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Example4.obj"
...
!ELSEIF  "$(CFG)" == "Example4 - Win32 (ALPHA) Debug"
...
CLEAN : 
	...
	-@erase ".\Example4\Example4.exe"
	-@erase ".\Example4\Example4.obj"
	-@erase ".\Example4\Example4.ilk"
	-@erase ".\Example4\Example4.pdb"
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib ntwdblib.lib /nologo /subsystem:console /incremental:yes\
 /pdb:"$(OUTDIR)/Example4.pdb" /debug /machine:ALPHA\
 /out:"$(OUTDIR)/Example4.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Example4.obj"
...
!ELSEIF  "$(CFG)" == "Example4 - Win32 (ALPHA) Release"
...
CLEAN : 
	-@erase ".\Example0\Example4.exe"
	-@erase ".\Example0\Example4.obj"
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib ntwdblib.lib /nologo /subsystem:console /incremental:no\
 /pdb:"$(OUTDIR)/Example4.pdb" /machine:ALPHA /out:"$(OUTDIR)/Example4.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Example4.obj"
...
!ELSEIF  "$(CFG)" == "Example4 - Win32 MIPS Debug"
...
CLEAN : 
	...
	-@erase ".\Example1\Example4.exe"
	-@erase ".\Example1\Example4.obj"
	-@erase ".\Example1\Example4.ilk"
	-@erase ".\Example1\Example4.pdb"
...
CPP_PROJ=/nologo /MLd /Gt0 /QMOb2000 /W3 /GX /Zi /Od /D "_DEBUG" /D "WIN32" /D\
 "_CONSOLE" /D "DBNTWIN32" /Fp"$(INTDIR)/Example4.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Example1/
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib ntwdblib.lib /nologo /subsystem:console /incremental:yes\
 /pdb:"$(OUTDIR)/Example4.pdb" /debug /machine:MIPS\
 /out:"$(OUTDIR)/Example4.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Example4.obj"
...
!ELSEIF  "$(CFG)" == "Example4 - Win32 MIPS Release"
...
CLEAN : 
	-@erase ".\Example2\Example4.exe"
	-@erase ".\Example2\Example4.obj"
...
CPP_PROJ=/nologo /ML /Gt0 /QMOb2000 /W3 /GX /O2 /D "NDEBUG" /D "WIN32" /D\
 "_CONSOLE" /D "DBNTWIN32" /Fp"$(INTDIR)/Example4.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Example2/
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib ntwdblib.lib /nologo /subsystem:console /incremental:no\
 /pdb:"$(OUTDIR)/Example4.pdb" /machine:MIPS /out:"$(OUTDIR)/Example4.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Example4.obj"
...
!ELSEIF  "$(CFG)" == "Example4 - Win32 (PPC) Release"
...
CLEAN : 
	-@erase ".\Example3\Example4.exe"
	-@erase ".\Example3\Example4.obj"
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)/Example4.pdb" /machine:PPC /out:"$(OUTDIR)/Example4.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Example4.obj"
...
!ELSEIF  "$(CFG)" == "Example4 - Win32 (PPC) Debug"
...
CLEAN : 
	...
	-@erase ".\Example5\Example4.exe"
	-@erase ".\Example5\Example4.obj"
	-@erase ".\Example5\Example4.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /GX /Zi /Od /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D\
 "DBNTWIN32" /Fp"$(INTDIR)/Example4.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Example5/
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib ntwdblib.lib /nologo /subsystem:console\
 /pdb:"$(OUTDIR)/Example4.pdb" /debug /machine:PPC /out:"$(OUTDIR)/Example4.exe"\
...
# Name "Example4 - Win32 (ALPHA) Debug"
# Name "Example4 - Win32 (ALPHA) Release"
# Name "Example4 - Win32 MIPS Debug"
# Name "Example4 - Win32 MIPS Release"
# Name "Example4 - Win32 (PPC) Release"
# Name "Example4 - Win32 (PPC) Debug"
...
"$(INTDIR)\Example4.obj" : $(SOURCE) $(DEP_CPP_EXAMP) "$(INTDIR)"
