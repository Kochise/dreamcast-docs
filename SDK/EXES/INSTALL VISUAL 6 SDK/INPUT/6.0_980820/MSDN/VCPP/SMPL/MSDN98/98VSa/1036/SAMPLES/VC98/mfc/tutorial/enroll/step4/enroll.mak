...
"$(INTDIR)\addform.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\enroll.pch"


SOURCE=.\coursset.cpp

"$(INTDIR)\coursset.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\enroll.pch"


SOURCE=.\crsform.cpp

"$(INTDIR)\crsform.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\enroll.pch"
