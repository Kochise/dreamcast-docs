// bldrec.cpp : Defines the initialization routines for the DLL.
//
...
class CBldrecApp : public CWinApp
{
public:
	CBldrecApp();
...
BEGIN_MESSAGE_MAP(CBldrecApp, CWinApp)
	//{{AFX_MSG_MAP(CBldrecApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CBldrecApp object

CBldrecApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CBldrecApp construction

CBldrecApp::CBldrecApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// CBldrecApp initialization

BOOL CBldrecApp::InitInstance()
{
	_Module.Init(ObjectMap, m_hInstance);
	return CWinApp::InitInstance();
}

int CBldrecApp::ExitInstance()
{
	_Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_BLDREC_DESCRIPTION);
