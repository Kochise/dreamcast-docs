 ...
 *
 * Implementation of CImpIConnectionPoint for the Beeper object
 * as well as CConnectionPoint for IPropertyNotifySink.
 *
 ...
 *  pObj            PCBeeper pointing to the object we live in.
 *  pUnkOuter       LPUNKNOWN of the controlling unknown.
 */

CImpIConnPtCont::CImpIConnPtCont(PCBeeper pObj
    , LPUNKNOWN pUnkOuter)
    {
    m_cRef=0;
    m_pObj=pObj;
...
CConnectionPoint::CConnectionPoint(PCBeeper pObj)
    {
    m_cRef=0;
