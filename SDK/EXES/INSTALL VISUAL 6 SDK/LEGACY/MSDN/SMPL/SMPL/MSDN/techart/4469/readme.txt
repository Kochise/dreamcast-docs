========================================================================
                    CUSTOM APPWIZARD: ntddwzd
========================================================================


AppWizard has created a ntddwzd DLL for you.  This DLL is the starting point
...
you build ntddwzd.awx, it will automatically be copied to your Template
...
ntddwzd.mak
    ...
    nmake /f ntddwzd.mak CFG="Win32 Debug".

    To build a release version of the program, type
    nmake /f ntddwzd.mak CFG="Win32 Release".
...
ntddwzdAw.h, ntddwzdAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CNtddwzdAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into ntddwzd.rc.  Be
...
StdAfx.h, StdAfx.cpp
    ...
    named ntddwzd.pch and a precompiled types file named StdAfx.obj.
