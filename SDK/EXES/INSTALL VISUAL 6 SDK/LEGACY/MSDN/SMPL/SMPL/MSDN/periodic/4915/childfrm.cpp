...
BEGIN_MESSAGE_MAP(CMyTitleBar, CTitleBar)
	//{{AFX_MSG_MAP(CMyTitleBar)
...
IMPLEMENT_DYNAMIC(CMyTitleBar, CTitleBar)
...
void CMyTitleBar::OnViewTitleInfo()
{
	m_bViewTitleInfo = !m_bViewTitleInfo;
}

void CMyTitleBar::OnUpdateUIViewTitleInfo(CCmdUI* pCmdUI)
{
	pCmdUI->SetCheck(m_bViewTitleInfo);
}

void CMyTitleBar::OnUpdateUINumStrokes(CCmdUI* pCmdUI)
{
