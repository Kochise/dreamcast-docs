...
#define INTERNET_LAST_OPTION                    INTERNET_OPTION_VERSION
...
#define ERROR_INTERNET_WOULD_BLOCK              (INTERNET_ERROR_BASE + 34)
...
#define INTERNET_ERROR_LAST                     ERROR_INTERNET_UNABLE_TO_CACHE_FILE
