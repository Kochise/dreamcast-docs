...
STDMETHODIMP_(ULONG) CTelevision::XDrawing::AddRef(void)
{
    METHOD_PROLOGUE(CTelevision, Drawing);
    return pThis->ExternalAddRef();
}
 
STDMETHODIMP_(ULONG) CTelevision::XDrawing::Release(void)
{
    METHOD_PROLOGUE(CTelevision, Drawing);
    return pThis->ExternalRelease();
}

STDMETHODIMP CTelevision::XDrawing::QueryInterface(REFIID riid, LPVOID* ppVoid)
{
    METHOD_PROLOGUE(CTelevision, Drawing);
...
STDMETHODIMP_(ULONG) CTelevision::XApplianceUI::AddRef(void)
{
    METHOD_PROLOGUE(CTelevision, ApplianceUI);
    return pThis->ExternalAddRef();
}
 
STDMETHODIMP_(ULONG) CTelevision::XApplianceUI::Release(void)
{
    METHOD_PROLOGUE(CTelevision, ApplianceUI);
    return pThis->ExternalRelease();
}

STDMETHODIMP CTelevision::XApplianceUI::QueryInterface(REFIID riid, LPVOID* ppVoid)
{
    METHOD_PROLOGUE(CTelevision, ApplianceUI);
    return pThis->ExternalQueryInterface(&riid, ppVoid);
}
