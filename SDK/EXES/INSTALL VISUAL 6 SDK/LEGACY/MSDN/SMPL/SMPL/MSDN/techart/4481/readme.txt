========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : NTSERVCPL
========================================================================


AppWizard has created this NTSERVCPL DLL for you.  This DLL not only
demonstrates the basics of using the Microsoft Foundation classes but
is also a starting point for writing your DLL.

This file contains a summary of what you will find in each of the files that
make up your NTSERVCPL DLL.
...
nmake /f NTSERVCPL.MAK CFG="Win32 Debug"
    or to build a release version of the program, type
nmake /f NTSERVCPL.MAK CFG="Win32 Release"
...
NTSERVCPL.CPP
	This is the main DLL source file.  It contains the class CNTServCplApp.
...
STDAFX.H, STDAFX.CPP
    ...
    named NTSERVCPL.PCH and a precompiled types file named STDAFX.OBJ.
