========================================================================
                    CUSTOM APPWIZARD: OneWndWz
========================================================================


AppWizard has created a OneWndWz DLL for you.  This DLL is the starting point
...
you build OneWndWz.awx, it will automatically be copied to your Template
...
OneWndWz.mak
    ...
    nmake /f OneWndWz.mak CFG="Win32 Debug".

    To build a release version of the program, type
    nmake /f OneWndWz.mak CFG="Win32 Release".
...
OneWndWzAw.h, OneWndWzAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    COneWndWzAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into OneWndWz.rc.  Be
...
StdAfx.h, StdAfx.cpp
    ...
    named OneWndWz.pch and a precompiled types file named StdAfx.obj.
