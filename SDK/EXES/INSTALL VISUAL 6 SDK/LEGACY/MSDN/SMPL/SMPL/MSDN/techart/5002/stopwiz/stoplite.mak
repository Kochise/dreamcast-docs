...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /D "_WINDLL" /D "_AFXDLL" /D "_MBCS" /D "_USRDLL" /Fp"$(INTDIR)/StopLite.pch"\
...
"$(OUTDIR)\StopLite.tlb" : $(SOURCE) "$(OUTDIR)"
...
"$(INTDIR)\StopLiteCtl.obj" : $(SOURCE) $(DEP_CPP_STOPLIT) "$(INTDIR)"\
 "$(INTDIR)\StopLite.pch"
...
"$(INTDIR)\StopLitePpg.obj" : $(SOURCE) $(DEP_CPP_STOPLITE) "$(INTDIR)"\
 "$(INTDIR)\StopLite.pch"
