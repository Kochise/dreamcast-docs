...
/*
 * CImpIDispatchEvents::CImpIDispatchEvents
 * CImpIDispatchEvents::~CImpIDispatchEvents
 *
 * Parameters (Constructor):
...
CImpIDispatchEvents::CImpIDispatchEvents(PCTenant pTen
    , LPUNKNOWN pUnkOuter)
    {
    m_cRef=0;
    m_pTen=pTen;
...
CImpIDispatchEvents::~CImpIDispatchEvents(void)
    {
    return;
    }
...
/*
 * CImpIDispatchEvents::QueryInterface
 * CImpIDispatchEvents::AddRef
 * CImpIDispatchEvents::Release
 *
 * Purpose:
 *  IUnknown members for CImpIDispatchEvents object.  Note that
 *  while QueryInterface operates only on this interface, the
 *  reference count affects the tenant as a whole.
 */

STDMETHODIMP CImpIDispatchEvents::QueryInterface(REFIID riid, PPVOID ppv)
    {
    *ppv=NULL;
...
STDMETHODIMP_(ULONG) CImpIDispatchEvents::AddRef(void)
    {
    ++m_cRef;
    return m_pUnkOuter->AddRef();
    }

STDMETHODIMP_(ULONG) CImpIDispatchEvents::Release(void)
    {
    m_cRef--;
...
/*
 * CImpIDispatchEvents::GetTypeInfoCount
 * CImpIDispatchEvents::GetTypeInfo
 * CImpIDispatchEvents::GetIDsOfNames
 *
 * Purpose:
...
STDMETHODIMP CImpIDispatchEvents::GetTypeInfoCount(UINT *pctInfo)
    {
    *pctInfo=NULL;
    return ResultFromScode(E_NOTIMPL);
    }

STDMETHODIMP CImpIDispatchEvents::GetTypeInfo(UINT itinfo
...
STDMETHODIMP CImpIDispatchEvents::GetIDsOfNames(REFIID riid
...
STDMETHODIMP CImpIDispatchEvents::Invoke(DISPID dispIDMember, REFIID riid
