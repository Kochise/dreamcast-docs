...
STDMETHODIMP_(ULONG) CRadio::XDrawing::AddRef(void)
{
    METHOD_PROLOGUE(CRadio, Drawing);
    return pThis->ExternalAddRef();
}
 
STDMETHODIMP_(ULONG) CRadio::XDrawing::Release(void)
{
    METHOD_PROLOGUE(CRadio, Drawing);
    return pThis->ExternalRelease();
}

STDMETHODIMP CRadio::XDrawing::QueryInterface(REFIID riid, LPVOID* ppVoid)
{
    METHOD_PROLOGUE(CRadio, Drawing);
...
STDMETHODIMP_(ULONG) CRadio::XApplianceUI::AddRef(void)
{
    METHOD_PROLOGUE(CRadio, ApplianceUI);
    return pThis->ExternalAddRef();
}
 
STDMETHODIMP_(ULONG) CRadio::XApplianceUI::Release(void)
{
    METHOD_PROLOGUE(CRadio, ApplianceUI);
    return pThis->ExternalRelease();
}

STDMETHODIMP CRadio::XApplianceUI::QueryInterface(REFIID riid, LPVOID* ppVoid)
{
    METHOD_PROLOGUE(CRadio, ApplianceUI);
    return pThis->ExternalQueryInterface(&riid, ppVoid);
}
