# Microsoft Developer Studio Project File - Name="VMU_Timer" - Package Owner=<4>
...
# ADD LINK32 coredll.lib corelibc.lib mapledev.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /pdb:"..\..\..\release\retail\Samples/VMU_Timer.pdb" /machine:SH4 /nodefaultlib /out:"..\..\..\release\retail\Samples/VMU_Timer.exe" /libpath:"..\..\lib\retail" /libpath:"..\..\..\lib\retail" /subsystem:$(CESubsystem)
...
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 coredll.lib corelibc.lib mapledev.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /incremental:no /pdb:"..\..\..\release\debug\Samples/VMU_Timer.pdb" /debug /machine:SH4 /nodefaultlib /out:"..\..\..\release\debug\Samples/VMU_Timer.exe" /libpath:"..\..\lib\debug" /libpath:"..\..\..\lib\debug" /subsystem:$(CESubsystem)
# SUBTRACT LINK32 /pdb:none
...
# Name "VMU_Timer - Win32 (WCE SH4) Release"
# Name "VMU_Timer - Win32 (WCE SH4) Debug"

# Begin Source File
SOURCE=.\VMU_Timer.cpp
# End Source File
# Begin Source File
