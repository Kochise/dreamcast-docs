...
LPDIRECTDRAWSURFACE g_pddsSprites;                  // Contains sprite image

// ++++ Local Variables +++++++++++++++++++++++++++++++++++++++++++++
TCHAR     g_tszAppName[] = TEXT("VMU_LCD");        // The App's Name
...
CleanUp()
{
    ...
    // Release the images bitmap
    if (g_pddsSprites)
        g_pddsSprites->Release();
...
AppInit(HINSTANCE hPrev, int nCmdShow)
{
    ...
    g_pddsSprites = LoadBitmapToDDS(TEXT("Sprites"));
    if (!g_pddsSprites)
        return FALSE;
