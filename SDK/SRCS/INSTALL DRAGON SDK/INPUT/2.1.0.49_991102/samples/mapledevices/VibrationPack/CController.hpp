...
public:
    ...
    // Called when an VibPack is discovered to be attached to the device
    void VibPackExists(GUID guidVibPack);

    // Get the Controller's VibPack object
    CVibPack *GetVibPack()              {return m_pvibpack; };
    void SetVibPack(CVibPack *pvibpack);
...
private:
    ...
    // The Controller's vibration pack
    CVibPack *m_pvibpack;
};    
