# Microsoft Developer Studio Project File - Name="Passport" - Package Owner=<4>
...
# ADD LINK32 coredll.lib corelibc.lib platutil.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /pdb:"..\..\..\release\retail\Samples/Passport.pdb" /machine:SH4 /nodefaultlib /out:"..\..\..\release\retail\Samples/Passport.exe" /libpath:"..\..\lib\retail" /libpath:"..\..\..\lib\retail" /subsystem:$(CESubsystem)
...
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 coredll.lib corelibc.lib platutil.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /incremental:no /pdb:"..\..\..\release\debug\Samples/Passport.pdb" /debug /machine:SH4 /nodefaultlib /out:"..\..\..\release\debug\Samples/Passport.exe" /libpath:"..\..\lib\debug" /libpath:"..\..\..\lib\debug" /subsystem:$(CESubsystem)
# SUBTRACT LINK32 /pdb:none
...
# Name "Passport - Win32 (WCE SH4) Release"
# Name "Passport - Win32 (WCE SH4) Debug"
