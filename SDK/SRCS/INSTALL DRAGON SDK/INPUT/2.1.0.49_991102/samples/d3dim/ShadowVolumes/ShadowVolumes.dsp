# Microsoft Developer Studio Project File - Name="ShadowVolumes" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "ShadowVolumes.mak".
!MESSAGE 
...
# ADD LINK32 coredll.lib corelibc.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /pdb:"..\..\..\release\retail\Samples/ShadowVolumes.pdb" /machine:SH4 /nodefaultlib /out:"..\..\..\release\retail\Samples/ShadowVolumes.exe" /libpath:"..\..\lib\retail" /libpath:"..\..\..\lib\retail" /subsystem:$(CESubsystem)
...
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 coredll.lib corelibc.lib ddraw.lib dinput.lib dxguid.lib  floatmath.lib  /nologo /incremental:no /pdb:"..\..\..\release\debug\Samples/ShadowVolumes.pdb" /debug /machine:SH4 /nodefaultlib /out:"..\..\..\release\debug\Samples/ShadowVolumes.exe" /libpath:"..\..\lib\debug" /libpath:"..\..\..\lib\debug" /subsystem:$(CESubsystem)
# SUBTRACT LINK32 /pdb:none
...
# Name "ShadowVolumes - Win32 (WCE SH4) Release"
# Name "ShadowVolumes - Win32 (WCE SH4) Debug"

# Begin Source File
SOURCE=.\ShadowVolumes.cpp
# End Source File
# Begin Source File
SOURCE=.\D3DUtil.cpp
# End Source File
