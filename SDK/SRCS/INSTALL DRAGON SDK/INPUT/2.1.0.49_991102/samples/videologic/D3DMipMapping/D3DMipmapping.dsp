# Microsoft Developer Studio Project File - Name="D3DMipmapping" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "D3DMipmapping.mak".
!MESSAGE 
...
# ADD LINK32 coredll.lib corelibc.lib ddraw.lib dinput.lib dxguid.lib floatmath.lib strig.lib shintr.lib /nologo /machine:SH4 /nodefaultlib:"$(CENoDefaultLib)" /subsystem:$(CESubsystem) /STACK:65536,4096
# Begin Special Build Tool
TargetPath=.\WCESH4Rel\D3DMipmapping.exe
SOURCE="$(InputPath)"
...
# ADD LINK32 coredll.lib corelibc.lib ddraw.lib dinput.lib dxguid.lib floatmath.lib strig.lib shintr.lib /nologo /debug /machine:SH4 /nodefaultlib:"$(CENoDefaultLib)" /subsystem:$(CESubsystem) /STACK:65536,4096
# Begin Special Build Tool
TargetPath=.\WCESH4Dbg\D3DMipmapping.exe
SOURCE="$(InputPath)"
PostBuild_Desc=Copying...
PostBuild_Cmds=dccopy $(TargetPath)
# End Special Build Tool
...
# Name "D3DMipmapping - Win32 (WCE SH4) Release"
# Name "D3DMipmapping - Win32 (WCE SH4) Debug"
# Begin Group "Source"

# PROP Default_Filter ""
# Begin Source File

SOURCE=.\D3DMipmapping.c
DEP_CPP_D3DMI=\
	".\D3DMipmapping.h"\
	".\D3DShell.h"\
	".\D3DTools.h"\
