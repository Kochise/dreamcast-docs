# Microsoft Developer Studio Project File - Name="LSPregistry" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "LSPregistry.mak".
!MESSAGE 
...
# ADD LINK32 coredll.lib ..\lib\retail\LSPdebug.lib /nologo /dll /machine:SH4 /nodefaultlib:"$(CENoDefaultLib)" /subsystem:$(CESubsystem) /STACK:65536,4096
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=copy WCESH4Rel\LSPregistry.dll ..\bin\retail	copy WCESH4Rel\LSPregistry.lib ..\lib\retail	copy WCESH4Rel\LSPregistry.dll c:\WCEDreamcast\release\retail\os
...
# ADD LINK32 coredll.lib ..\lib\debug\LSPdebug.lib /nologo /dll /debug /machine:SH4 /nodefaultlib:"$(CENoDefaultLib)" /subsystem:$(CESubsystem) /STACK:65536,4096
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=copy    WCESH4Dbg\LSPregistry.lib  ..\lib\debug	copy    WCESH4Dbg\LSPregistry.dll  ..\bin\debug	copy    WCESH4Dbg\LSPregistry.pdb  ..\bin\debug	copy    WCESH4Dbg\LSPregistry.dll  c:\WCEDreamcast\release\debug\os	copy    WCESH4Dbg\LSPregistry.pdb  c:\WCEDreamcast\release\debug\os
# End Special Build Tool
...
# Name "LSPregistry - Win32 (WCE SH4) Release"
# Name "LSPregistry - Win32 (WCE SH4) Debug"
