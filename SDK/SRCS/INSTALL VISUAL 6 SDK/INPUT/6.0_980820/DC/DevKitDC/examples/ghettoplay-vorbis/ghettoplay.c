/* GhettoPlay: an S3M browser and playback util
   ...
   NOTE:
   This is a changed version of the original example GhettoPlay. All
   calls for S3M Playback have been exchanged with sndoggvorbis calls !

   This is just for demonstration purposes on how to use sndoggvorbis
   in your application !
...
//	serial_disable();
	...
	while (!check_start()) {
		...
		draw_poly_strf(5.0f, 20.0f, 100.0f, 1.0f, 1.0f, 1.0f, 1.0f,
			"GhettoPlay Vorbis - Original (C)2001 by Dan Potter");
		...
		if(sndoggvorbis_isplaying())
		{
			...
			draw_poly_strf(30.0f+(12.0f*7),440.0f-96.0f+6+24.0f+10.0f,100.0f,1.0f,1.0f,1.0f,1.0f,sndoggvorbis_getartist());
			draw_poly_strf(30.0f+(12.0f*6),440.0f-96.0f+6+48.0f+10.0f,100.0f,1.0f,1.0f,1.0f,1.0f,sndoggvorbis_gettitle());
			draw_poly_strf(320.0f+(12.0f*6),440.0f-96.0f+6+24.0f+10.0f,100.0f,1.0f,1.0f,1.0f,1.0f,sndoggvorbis_getgenre());
		}
