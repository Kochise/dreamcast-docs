...
LRESULT CCosmoFrame::OnCommand(HWND hWnd, WPARAM wParam
    ...
    switch (wID)
        ...
        case IDM_FILEOPEN:
            /*
             * When we're open for OLE Automation, the use might
             * create a new document or such in which case we have
             * to make suer we don't just shut down prematurely.
             */
            g_fUser=TRUE;
 ...
 *
 * Purpose:
 *  Returns the 'application' automation object pointer
 *
 * Return Value:
 *  PCAutoApp       Pointer to the application object
 */

PCAutoApp CCosmoFrame::AutoApp(void)
    {
    return m_pAutoApp;
    }
//End CHAPTER14MOD
