...
#if !defined(AFX_STDAFX_H__D93F3A0F_3DA9_11D0_B889_00C04FD7A0F0__INCLUDED_)
#define AFX_STDAFX_H__D93F3A0F_3DA9_11D0_B889_00C04FD7A0F0__INCLUDED_
...
void GetLastErrorDescription(CComBSTR& bstr);       // Defined in AutoBld.cpp
#define VERIFY_OK(f) \
	{ \
		HRESULT hr = (f); \
		if (hr != S_OK) \
...
#endif // !defined(AFX_STDAFX_H__D93F3A0F_3DA9_11D0_B889_00C04FD7A0F0__INCLUDED)
