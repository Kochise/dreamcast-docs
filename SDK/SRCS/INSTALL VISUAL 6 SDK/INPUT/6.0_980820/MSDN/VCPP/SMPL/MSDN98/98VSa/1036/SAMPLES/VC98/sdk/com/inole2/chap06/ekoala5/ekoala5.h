/*
 * EKOALA5.H
 * Koala Object EXE Server with Custom Marsaling Chapter 6
 *
...
class CKoalaClassFactory : public IClassFactory
    ...
    protected:
        ULONG           m_cRef;
        HINSTANCE       m_hInst;        //To give to Koalas
        HWND            m_hWnd;         //To give to Koalas

    public:
        CKoalaClassFactory(HINSTANCE, HWND);
