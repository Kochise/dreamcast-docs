...
#include "adosamp.h"
// TO DO: Edit import path
#pragma message ("TO DO:  Add the path to msado10.dll to Tools.Options.Directories.Include Files.  This is usually \"c:\\Program Files\\Common Files\\system\\ado\"")
#import <msado10.dll> raw_interfaces_only no_namespace exclude("DataTypeEnum") exclude("ParameterDirectionEnum")
