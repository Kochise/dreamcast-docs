# Microsoft Developer Studio Project File - Name="AtlAgent" - Package Owner=<4>
...
# ADD CPP /nologo /MT /W3 /O1 /D "_ATL_DLL" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_USRDLL" /Yu"stdafx.h" /FD /c
...
# ADD CPP /nologo /MT /W3 /O1 /D "_ATL_STATIC_REGISTRY" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_USRDLL" /Yu"stdafx.h" /FD /c
# ADD BASE MTL /nologo /D "NDEBUG" /mktyplib203 /o "NUL" /win32
# ADD MTL /nologo /D "NDEBUG" /mktyplib203 /o "NUL" /win32
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
...
# Name "AtlAgent - Win32 Debug"
# Name "AtlAgent - Win32 Unicode Debug"
# Name "AtlAgent - Win32 Release MinSize"
# Name "AtlAgent - Win32 Release MinDependency"
# Name "AtlAgent - Win32 Unicode Release MinSize"
# Name "AtlAgent - Win32 Unicode Release MinDependency"
...
InputPath=.\AtlAgent.idl

BuildCmds= \
	midl /Oicf /h "AtlAgent.h" /iid "AtlAgent_i.c" "AtlAgent.idl"

".\AtlAgent.tlb" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

".\AtlAgent.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

".\AtlAgent_i.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
