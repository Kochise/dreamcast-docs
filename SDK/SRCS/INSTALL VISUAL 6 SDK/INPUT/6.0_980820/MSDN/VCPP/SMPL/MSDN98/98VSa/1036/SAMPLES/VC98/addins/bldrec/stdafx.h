...
#if !defined(AFX_STDAFX_H__36FDE86D_EA61_11D0_B595_00A0C91BC942__INCLUDED_)
#define AFX_STDAFX_H__36FDE86D_EA61_11D0_B595_00A0C91BC942__INCLUDED_
...
void GetLastErrorDescription(CComBSTR& bstr);		// Defined in bldrec.cpp
#define VERIFY_OK(f) \
	{ \
		HRESULT hr = (f); \
		if (hr != S_OK) \
...
#endif // !defined(AFX_STDAFX_H__36FDE86D_EA61_11D0_B595_00A0C91BC942__INCLUDED)
