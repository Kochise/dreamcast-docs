...
void CCourseForm::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_FieldText(pDX, IDC_COURSEID, m_pSet->m_course.m_CourseID, m_pSet);
	DDX_FieldText(pDX, IDC_HOURS, m_pSet->m_course.m_Hours, m_pSet);
	DDX_FieldText(pDX, IDC_TITLE, m_pSet->m_course.m_CourseTitle, m_pSet);
	//}}AFX_DATA_MAP
}
...
void CCourseForm::OnRecordDelete()
{
	...
	sectionSet.m_strCourseIDParam = m_pSet->m_course.m_CourseID;
	...
	CUpdateHint hint;
	hint.m_strCourse = m_pSet->m_course.m_CourseID;
