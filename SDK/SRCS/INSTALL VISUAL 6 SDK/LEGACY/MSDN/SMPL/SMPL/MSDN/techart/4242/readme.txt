========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : GLLIB
========================================================================


AppWizard has created this GLLIB DLL for you.  This DLL not only
demonstrates the basics of using the Microsoft Foundation classes but
is also a starting point for writing your DLL.

This file contains a summary of what you will find in each of the files that
make up your GLLIB DLL.
...
nmake /f GLLIB.MAK CFG="Win32 Debug"
    or to build a release version of the program, type
nmake /f GLLIB.MAK CFG="Win32 Release"
...
STDAFX.H, STDAFX.CPP
    ...
    named GLLIB.PCH and a precompiled types file named STDAFX.OBJ.
