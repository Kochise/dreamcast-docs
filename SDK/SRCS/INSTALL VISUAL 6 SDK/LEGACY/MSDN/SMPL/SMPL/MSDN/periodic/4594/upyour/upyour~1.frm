VERSION 4.00
Begin VB.Form frmUpYours 
   Caption         =   "Up Yours: The MSJ Finger Demo"
   ClientHeight    =   3600
   ClientLeft      =   5385
   ClientTop       =   3900
   ClientWidth     =   6090
   ...
   End
End
Attribute VB_Name = "frmUpYours"
Attribute VB_Creatable = False
Attribute VB_Exposed = False
'-----------------------------------------------------
' UP YOURS.FRM
'   This is the form definition for Up Yours: The MSJ
'   Finger program.


'-----------------------------------------------------
' When the "Finger" button is clicked, Up Yours should
...
Private Sub MSJSockCtrl_RecvData(ByVal hTask As Long, ByVal Data As String)
    ...
    ' there's data to receive, Up Yours calls it to receive the data.
