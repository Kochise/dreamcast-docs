...
#REVIEW: does Docobj support UNICODE?
...
#
!if "$(PLATFORM)" == "INTEL"
CL_OPT=/W3 /WX /Zl /GX $(DEBOPTS) $(CVOPTS) $(TARGOPTS)
!endif
...
!if "$(PLATFORM)" == "PPC"
CL_OPT=/W3 /Zl $(DEBOPTS) $(CVOPTS) $(TARGOPTS)
!endif
...
OBJS=$D\binddcmt.obj $D\binddoc.obj $D\bindipfw.obj $D\binditem.obj $D\bindtarg.obj     $D\bindview.obj  \
     $D\mfcbind.obj $D\oleobjct.obj $D\print.obj
