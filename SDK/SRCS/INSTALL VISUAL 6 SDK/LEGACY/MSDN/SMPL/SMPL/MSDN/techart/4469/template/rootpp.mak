...
!MESSAGE No configuration specified.  Defaulting to $$SAFE_ROOT$$ - Win32 NT\
 kernel driver (debug).
!ENDIF 
...
CLEAN : 
	...
	-@erase ".\WinRel\drvclass.obj"
	-@erase ".\WinRel\$$SAFE_ROOT$$dep.obj"
	-@erase ".\WinRel\devext.obj"
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/rootpp.bsc" 
BSC32_SBRS=
LINK32=link.exe
...
CLEAN : 
	...
	-@erase ".\WinDebug\devext.obj"
	-@erase ".\WinDebug\$$SAFE_ROOT$$dep.obj"
	-@erase ".\WinDebug\drvclass.obj"
...
LINK32_FLAGS=/nologo /base:0x10000 /entry:"DriverEntry@8" /incremental:no\
 /pdb:"$(OUTDIR)/$$SAFE_ROOT$$.pdb" /debug /debugtype:both /machine:I386\
 /nodefaultlib /out:"c:\ddk\lib\i386\checked\$$SAFE_ROOT$$.sys"\
 /SUBSYSTEM:native 
LINK32_OBJS= \
	"$(INTDIR)/devext.obj" \
	"$(INTDIR)/$$SAFE_ROOT$$dep.obj" \
...
"$(INTDIR)\drvclass.obj" : $(SOURCE) $(DEP_CPP_DRVCL) "$(INTDIR)"
...
"$(INTDIR)\devext.obj" : $(SOURCE) $(DEP_CPP_DEVEX) "$(INTDIR)"
