...
// @mfunc int | CTransBmp | GetWidth | Gets the width of the bitmap.
// @syntax int GetWidth(); 
// @rdesc The width of the bitmap in pixels.
// @xref <c CTransBmp> <mf CTransBmp::GetHeight>
...
// @mfunc int | CTransBmp | GetHeight | Gets the height of the bitmap.
// @syntax int GetHeight(); 
// @rdesc The height of the bitmap in pixels.
// @xref <c CTransBmp> <mf CTransBmp::GetWidth>
...
// @mfunc void | CTransBmp | Draw | Draws the bitmap.
// @syntax void Draw(HDC hDC, int x, int y); 
// @syntax void Draw(CDC* pDC, int x, int y);
// @parm CDC* | pDC | A pointer to a CDC object.
// @parm HDC | hDC | A handle to a GDI DC.
// @parm int | x | The x coordinate at which the bitmap is to be drawn.
// @parm int | y | The y coordinate at which the bitmap is to be drawn.
// @rdesc Nothing.
// @comm The bitmap is drawn without transparency.
// @xref <c CTransBmp> <mf CTransBmp::DrawTrans>
...
// @mfunc void | CTransBmp | DrawTrans | Draws the bitmap with
//  transparency.
// @syntax void DrawTrans(HDC hDC, int x, int y); 
// @syntax void DrawTrans(CDC* pDC, int x, int y);
// @parm CDC* | pDC | A pointer to a CDC object.
// @parm HDC | hDC | A handle to a GDI DC.
// @parm int | x | The x coordinate at which the bitmap is to be drawn.
// @parm int | y | The y coordinate at which the bitmap is to be drawn.
// @rdesc Nothing.
// @comm The bitmap is drawn with transparency. The top left pixel 
//  of the bitmap determines the transparency color.
// @xref <c CTransBmp> <mf CTransBmp::Draw>
