...
'Get the user who posted the message
    ...
    mynewrecipient.Name = addentry.Name
    mynewrecipient.resolve
	
if Request.Form("Approve") = "Approve" then
    newExpenseReport.subject = "Your expense report has been Approved!"
    newExpenseReport.text = Approver & " has approved the expense report.  The total value of this report was " & Total
    ...
    newExpenseReport.subject = "Your expense report has been Rejected!"
    newExpenseReport.text = Approver & " has rejected the expense report.  The total value of this report was " & Total
    newExpenseReport.send
...
<p><font size="6" face="Arial Black">
<% if currentstatus = 3 then %>

Routing Final Approval to <%=addentry.Name%></font></p>
<hr>
<font size="6" face="Arial Black">The following funds have been successfully transferred:
