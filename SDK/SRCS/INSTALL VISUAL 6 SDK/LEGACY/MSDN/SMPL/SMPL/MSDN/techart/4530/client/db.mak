...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "Win32 Unicode Debug"
MTL=MkTypLib.exe
CPP=cl.exe
RSC=rc.exe
...
$(INTDIR)/guids.obj :  $(SOURCE)  $(DEP_GUIDS) $(INTDIR)
   $(CPP) /nologo /MD /W3 /GX /Zi /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /D "_AFXDLL" /FR$(INTDIR)/ /Fo$(INTDIR)/ /Fd$(OUTDIR)/"DB.pdb" /c\
  $(SOURCE) 
...
$(INTDIR)/guids.obj :  $(SOURCE)  $(DEP_GUIDS) $(INTDIR)
   $(CPP) /nologo /MD /W3 /GX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /D "_AFXDLL" /FR$(INTDIR)/ /Fo$(INTDIR)/ /c  $(SOURCE) 
...
$(INTDIR)/guids.obj :  $(SOURCE)  $(DEP_GUIDS) $(INTDIR)
   $(CPP) /nologo /MD /W3 /GX /Zi /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /D "_AFXDLL" /D "UNICODE" /FR$(INTDIR)/ /Fo$(INTDIR)/\
...
$(INTDIR)/guids.obj :  $(SOURCE)  $(DEP_GUIDS) $(INTDIR)
   $(CPP) /nologo /MD /W3 /GX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "_MBCS" /D "_AFXDLL" /D "UNICODE" /FR$(INTDIR)/ /Fo$(INTDIR)/ /c  $(SOURCE) 
