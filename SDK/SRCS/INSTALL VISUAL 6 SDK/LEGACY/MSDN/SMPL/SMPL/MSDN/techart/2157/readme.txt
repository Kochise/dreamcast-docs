========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : DLDETECT
========================================================================

AppWizard has generated this DLDETECT application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your DLDETECT application.
...
DLDETECT.MAK
	...
	nmake DEBUG=1 /f DLDETECT.MAK
    or to build a release version of the program, type
	nmake DEBUG=0 /f DLDETECT.MAK
...
DLDETECT.H
    ...
    CDldetectApp application class.
...
RES\DLDETECT.ICO
    ...
    icon is included by the main resource file DLDETECT.RC.
...
DLDETDOC.H, DLDETDOC.CPP - the document
    These files contain your CDldetectDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CDldetectDoc::Serialize).

DLDETVW.H, DLDETVW.CPP - the view of the document
    These files contain your CDldetectView class.
    CDldetectView objects are used to view CDldetectDoc objects.

RES\DLDETDOC.ICO
    This is an icon file, which is used as the icon for MDI child windows
    for the CDldetectDoc class.  This icon is included by the main
    resource file DLDETECT.RC.
