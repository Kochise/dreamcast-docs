/* KallistiOS 1.1.9
   ...
   KGL-X mods by Heinrich Tillack, 2003 <http://a128.ch9.de>
   	Look at the new MENU option ZNEAR clipping on/off!!!
*/
#include <GL/gl.h>
#include <GL/glu.h>
#include <kos.h>
...
CVSID("$Id: tunnel.cpp,v 1.6 2002/04/07 03:31:51 axlen Exp $");
...
static void do_init() {
    ...
    /* KGL-X */
    fm->add(0,    1,    1,  &zclip, 	"Z_NEAR Clipping.... %d");
...
// 			static int count=0;
// 				char  buffer[256];
// 			sprintf(buffer,"/pc/home/shoots/shot%..ppm", count++);
...
//     pvr_get_stats(&stats);
//     printf("Frame Count: %d, last_time: %f, frame rate: %f fps\n",
//            stats.frame_count, stats.frame_last_time, stats.frame_rate);
