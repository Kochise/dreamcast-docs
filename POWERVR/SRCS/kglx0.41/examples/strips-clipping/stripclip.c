/* KallistiOS 1.1.9
   ...
   stripclip.c ( GL_TRIANGLE_STRIP znear clipping)
   based on code (c)2001, 2002 Trilinear@hotmail.com, Paul Boese

   mods by Heinrich Tillack, 2003
*/

/*
    A demonstration of my TRI STRIPS NEAR-Z-Clipper that has been
    ...
    on or off. Please note that the code works with GL_TRIANGLES, GL_QUADS
    and  for GL_TRIANGLE_STRIP.
